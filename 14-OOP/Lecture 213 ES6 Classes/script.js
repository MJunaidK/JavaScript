...
// Class declaration
class PersonCl {
  //constructor actually works in a pretty similar way as a constructor function,
...
const haroon = new PersonCl('Haroon', 1996);
console.log(haroon);
haroon.calcAge();

console.log(haroon.__proto__ === PersonCl.prototype);
